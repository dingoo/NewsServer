        ...
        <td>
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
                <tr>
                    ...
                    <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6">
                        <div align="center"><span class="STYLE10">用户类型</span></div>
                    </td>
                    <td width="15%" height="20" bgcolor="d3eaef" class="STYLE6">
                        <div align="center"><span class="STYLE10">密码</span></div>
                    </td>
                    <td width="14%" height="20" bgcolor="d3eaef" class="STYLE6">
                        <div align="center"><span class="STYLE10">头像</span></div>
                    </td>
                    <td width="14%" height="20" bgcolor="d3eaef" class="STYLE6">
                        <div align="center"><span class="STYLE10">昵称</span></div>
                    </td>
                    <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6">
                        <div align="center"><span class="STYLE10">所在城市</span></div>
                    </td>
                    <td width="14%" height="20" bgcolor="d3eaef" class="STYLE6">
                ...
                <tr>
                    ...
                    <td height="20" bgcolor="#FFFFFF" class="STYLE6">
                        <div align="center"><span class="STYLE19">普通</span></div>
                    </td>
                    <td height="20" bgcolor="#FFFFFF" class="STYLE19">
                        <div align="center"><?php echo $rs['password'];?></div>
                    </td>
                    <td height="20" bgcolor="#FFFFFF" class="STYLE19">
                        <div align="center"><?php echo $rs['usericon'];?></div>
                    </td>
                    <td height="20" bgcolor="#FFFFFF" class="STYLE19">
                        <div align="center"><?php echo $rs['nickname']?></div>
                    </td>
                    <td height="20" bgcolor="#FFFFFF" class="STYLE19">
                        <div align="center"><?php echo $rs['city']?></div>
                    </td>
                    <td height="20" bgcolor="#FFFFFF" class="STYLE19">
                        <div align="center"><?php echo $rs['phonenum']?></div>
                    </td>
                    <td height="20" bgcolor="#FFFFFF">
