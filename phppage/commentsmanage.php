                                ...
                                <td>
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            ...
                                            <td width="94%" valign="bottom"><span class="STYLE1"> 用户评论基本信息列表</span></td>
                                        </tr>
                                    </table>
                                </td>
                                <td>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
                <tr>
                    ...
                    <td width="40%" height="20" bgcolor="d3eaef" class="STYLE6">
                        <div align="center"><span class="STYLE10">评论内容</span></div>
                    </td>
...
//                    select n.title,u.username,c.content,c.time
//	                    from `newsserver`.`newsinfo` n,`newsserver`.`userinfo` u,`newsserver`.`comments` c
//	                    where n.newid=c.newsid and u.userid=c.usersid;

                    $sql="select n.title,u.username,c.content,c.time ".
                            "from newsinfo n,userinfo u,comments c ".
                            "where n.newid=c.newsid and u.userid=c.usersid";
